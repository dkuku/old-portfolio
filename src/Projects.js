...
import { Card, Header, Container, Item, Grid } from 'semantic-ui-react'
...
export default class Projects extends Component {
    static defaultProps = {
        projects:[{
            ...
            description: "Website made using wordpress and some additional plugins",
            ...
            description: 'Frontend made using bootstrap and svg for diagonal sections',
            ...
            description: 'Application uses node.js express and socket.io. Couple of users can login to the same room and chat',
            ...
            description: 'using javascript, jQuery and local storage for storing todos between restarts',
            ...
            img: 'portfolio.jpg',
            desc: 'Portfolio site',
            description: 'Made using react, react-router and semantic-ui',
