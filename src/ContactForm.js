...
export default class ContactForm extends Component {
    ...
    handleChange = (e, { name, value }) => this.setState({ [name]: value })
      ...
      handleSubmit = () => {
        ...
        this.setState({ submittedSubject: subject, submittedMessage: message })
      }
    
      render() {
        const { subject, message, submittedSubject, submittedMessage } = this.state;
        ...
        return (
          <div>
            ...
            <pre>{JSON.stringify({ submittedSubject, submittedMessage }, null, 2)}</pre>
          </div>
        )
    }
}
